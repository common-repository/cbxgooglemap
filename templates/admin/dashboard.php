...
$doc_url    = CBXGooglemapHelper::url_utmy( 'https://codeboxr.com/doc/cbxmap-doc/' );
?>
<div class="wrap">
    <div class="cbx-backend_container_header">
        <div class="cbx-backend_wrapper cbx-backend_header_wrapper">
            <div class="menu-heading">
                <img title="CBX Maps - Helps & Updates"
                     src="<?php echo CBXGOOGLEMAP_ROOT_URL . 'assets/img/icon_log.svg'
				     ?>" alt="CBX Maps - Helps & Updates" width="32" height="32">
                <h2 class="wp-heading-inline wp-heading-inline-setting">
					<?php esc_html_e( 'CBX Maps - Helps & Updates', 'cbxgooglemap' ); ?>
                </h2>
            </div>
            <a href="<?php echo admin_url() . 'edit.php?post_type=cbxgooglemap&page=cbxgooglemapsettings' ?>" class="button button-primary
            save-settings"> <?php esc_html_e( 'Go to Settings', 'cbxgooglemap' ); ?><img
            ...
            <div class="cbx-backend-row">
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                                        ...
                                        <div class="feature-card-body static">
                                            <div class="feature-card-header">
                                                <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                   target="_blank"> <img
                                                            src="https://codeboxr.com/wp-content/uploads/productshots/10560-profile.png"
                                                            alt="CBX Maps for WordPress"/> </a>

                                            </div>
                                            <div class="feature-card-description">
                                                <h3>
                                                    <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                       target="_blank">CBX Maps Pro Addon</a></h3>
                                                <p>Pro features for CBX Maps plugin.</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Changelog', 'cbxgooglemap' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            ...
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li>[improvement] Backend UI improved</li>
                                    <li>[new] Hide leaflet branding yes/no globally from setting - default show as was
                                        before
                                    </li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    ...
                                    <li><strong>[improvement]</strong> Add new menu Helps & Update.</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    ...
                                    <li><strong>[fixed]</strong> WPBakery Latest version compatibility fix.</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[new]</strong> Openstreep map now has location search for quick lat, lng
                                    </li>
                                </ul>
                            </div>
                        </div>
							...
							if ( function_exists( 'fetch_feed' ) ) {
								...
								if ( ! is_wp_error( $feed ) ) : $feed->init();
									...
									foreach ( $blocks as $block ) {
										...
										$url = CBXGooglemapHelper::url_utmy( $url ); ?>
                                        <div class="cbx-backend-settings-row">
                        ...
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <a href="https://codeboxr.com/contact-us" target="_blank">
									...
									<?php esc_html_e( 'Access our Premium Support', 'cbxgooglemap' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="mailto:info@codeboxr.com&subject=Need%20support%20for%20CBX%20Maps"
                                   target="_blank">
									...
									<?php esc_html_e( 'Quick Support (Email)', 'cbxgooglemap' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $plugin_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'CBX Maps Plugin Information', 'cbxgooglemap' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $doc_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'Read the CBX Maps User Guide', 'cbxgooglemap' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://wordpress.org/support/plugin/cbxgooglemap/reviews/#new-post"
                                   target="_blank">
									...
									<?php esc_html_e( 'Rate Our Plugin', 'cbxgooglemap' ); ?> </a>
                            </div>
                        </div>
